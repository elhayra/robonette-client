...
import com.robonette.argubit.robonette.activities.ConnectActivity;
import com.robonette.argubit.robonette.activities.ImgActivity;
import com.robonette.argubit.robonette.activities.MapActivity;
import com.robonette.argubit.robonette.protocol.ConnectionManager;

public abstract class NavBarActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.navbar_layout);// The base layout that contains your navigation drawer.
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        else if (selectedTitle.equals("Connection"))
        {
